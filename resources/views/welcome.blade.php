...
<body>
    <nav class="navbar bg-body-tertiary">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="">
                <img src="/assets/images/users/smk-logo.png" alt="Logo" height="74" class="d-inline-block align-text-top me-3">
                <div class="profile">
    ...
    <div class="container mt-4">
        <hr>
        <h2 class="text-center mb-4"><span class="text-primary">Peta</span> Lokasi</h2>
